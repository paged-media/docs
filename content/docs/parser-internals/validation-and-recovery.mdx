...
[style cascade](/docs/styles) needs. A paragraph that doesn't carry its own
...
The standalone [Tagged XML](/docs/tagged-xml) structure (IDML's `XMLElement` /
...
[Edge cases](/docs/edge-cases), which catalogues the behaviour from the reader's side.
