...
1. **Open the [design map](/docs/idml/package-anatomy/the-design-map)** and read
...
- **A `TextVariableInstance` contributes its `ResultText`.** Where a story carries
  ...
  the frozen `ResultText` — see [text variables](/docs/idml/stories-text/text-variables).
- **Threaded stories are still one story.** Text that flows across several frames
  ...
  display it. See [threading and overset](/docs/idml/stories-text/threading-and-overset).
...
[threading and overset](/docs/idml/stories-text/threading-and-overset).
