...
<SupportBadge feature="stories-text.overset" note="overset clipped to match InDesign, and now reported on BuiltDocument.diagnostics; an auto-height frame grows to fit instead of clipping" />

The text is still fully present in the story part — extraction (see
[extract all text](/docs/idml/stories-text/extract-all-text)) returns it all. Only the
