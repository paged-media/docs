...
description: The Layer element's attributes and the ItemLayer back-reference that assigns a page item to a layer, and how the parser reads each end of that link.
tier: intermediate
diataxis: reference
status: published
owner: paged-docs
...
[visibility and printing](/docs/idml/layers/visibility-and-printing).
