...
element. The same `Color/Red` can fill a [rectangle](/docs/idml/geometry-coordinates/item-transform),
...
- [Colors & swatches](/docs/idml/color-swatches/colors-and-swatches) — the `<Color>`
  and `<Swatch>` attributes, the reserved built-ins, and what each space means.
- [Gradients & tints](/docs/idml/color-swatches/gradients-and-tints) — `<Gradient>`,
  `<GradientStop>`, and the two ways a tint reaches a color.
- [Spot & process color](/docs/idml/color-swatches/spot-and-process) — why spot inks
