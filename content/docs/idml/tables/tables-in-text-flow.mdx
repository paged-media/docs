...
The [table model](/docs/idml/tables/the-table-model) and its
[rows, columns, and cells](/docs/idml/tables/rows-columns-cells) describe what a table
...
lands*. The story flows down its [text frame](/docs/idml/stories-text) — paragraph
...
A story can be [threaded](/docs/idml/stories-text) through a chain of frames, so its
...
[`RepeatingHeader` and `RepeatingFooter`](/docs/idml/tables/the-table-model#header-and-footer-repetition)
...
<SupportBadge feature="tables.header-footer-repeat" note="repeating header/footer — once-per-frame replay; BreakHeaders/BreakFooters modes and SkipFirst/SkipLast not yet read" />
