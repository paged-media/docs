...
than full strength. Both build on the [colors](/docs/color-swatches/colors-and-swatches)
...
- **Swatch-level tint** — a spot `<Color>` can carry a `TintValue` (0–100) that
  ...
  *is* the tinted color everywhere it is used. This is covered with the spot
  mechanics in [spot & process color](/docs/color-swatches/spot-and-process).
