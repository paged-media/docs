...
whole-spread pasteboard is still on the roadmap. <SupportBadge status="parsed-not-rendered" note="Spread ItemTransform: translation faithful (cancels per-page); rotation/scale deferred" />
