...
| `apiVersion` | string | yes | Range against `@paged-media/plugin-api` — `*`, exact (`0.2.0`), or caret (`^0.2`). See [Versioning](/docs/plugin-sdk/versioning) for the 0.x caret rule. The host refuses unsatisfied ranges at load. |
