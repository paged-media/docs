...
[the design map](/docs/package-anatomy/the-design-map). It is worth seeing in both
...
where it could bite — are the subject of [compatibility](/docs/round-tripping/compatibility).
