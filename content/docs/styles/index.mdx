...
[paragraph styles](/docs/styles/paragraph-styles),
[character styles](/docs/styles/character-styles),
[object styles](/docs/styles/object-styles), and
[table and cell styles](/docs/styles/table-and-cell-styles). Paragraph and
character styles format text; object styles format page items; table and cell
styles dress [tables](/docs/tables).
...
[`BasedOn` chain](/docs/styles/the-cascade), then the root defaults at the bottom
