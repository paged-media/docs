...
[tools with gesture handlers](/docs/paged/plugin-sdk/the-gesture-kit) — that is how
Paged's own pen tool ships — and panels, overlays, and keybindings. Read
[The BundleHost](/docs/paged/plugin-sdk/the-bundle-host) for everything the `host`
object carries.
